...
const HeroNavigation = () => {
  ...
  const businessItems: NavItem[] = [
    ...
    { name: 'PowerPlus', path: 'https://www.powerplus.com.pk/', isExternal: true },
    { name: 'PakGhiza', path: 'https://www.pakghiza.com/', isExternal: true },
  ];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/60 to-black/20 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 lg:h-24">
          {/* Left Navigation - Hidden on mobile and tablet */}
              ...
              item.hasDropdown ? (
                ...
                >
                  ...
                  <div className={`absolute top-full right-0 mt-2 w-56 bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-200 py-3 z-50 transition-all duration-300 ${
                    businessDropdown ? 'opacity-100 visible transform translate-y-0' : 'opacity-0 invisible transform -translate-y-4'
                  }`}>
