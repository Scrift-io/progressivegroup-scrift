...
const BuildingMaterials = () => {
  ...
  return <div className="mt-16 sm:mt-20 lg:mt-24">
      <PageHeader title="Building Materials" subtitle="Premium solutions for modern construction and interior design" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            return <div key={index} className={`bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 ${product.image ? 'grid md:grid-cols-2 gap-0' : ''}`}>
                  {product.image && <div className={`${!isEven ? 'md:order-2' : ''} relative h-64 md:h-auto overflow-hidden`}>
                      <img src={product.image} alt={`${product.title} - Premium building material`} className="w-full h-full object-cover transform hover:scale-110 transition-transform duration-700" />
      ...
      <section className="py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            return <div key={index} className="text-center bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 group">
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {['Residential Buildings', 'Commercial Spaces', 'Industrial Facilities', 'Interior Design'].map((application, index) => <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-100 group hover:border-pg-red/30">
      ...
      <section className="py-16 bg-gradient-to-r from-pg-red to-red-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="inline-flex items-center justify-center bg-white text-pg-red px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Get in Touch
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <a href="tel:+92-123-4567890" className="inline-flex items-center justify-center border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-pg-red transition-all duration-300 transform hover:scale-105">
              Call: +92-123-4567890
            </a>
          </div>
        </div>
