                    ...
                    {index === 0 ? (
                        <div className="relative">
                          <div style={{ position: 'relative', width: '100%', height: 0, paddingBottom: '56.250%' }}>
                            <iframe 
                              src="https://www.youtube.com/embed/GX0DJ4egJqQ?si=QI6skXf_zredOy-X" 
                        ...
                        <div className="relative">
                          <div style={{ position: 'relative', width: '100%', height: 0, paddingBottom: '56.250%' }}>
                            <iframe 
                              src="https://www.youtube.com/embed/ajxrgbNEoeI?si=sfpYw7fpBNnx3ydw" 
                              title="YouTube video player" 
                              frameBorder="0" 
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                              referrerPolicy="strict-origin-when-cross-origin" 
                        ...
                        <div className="relative">
                          <div style={{ position: 'relative', width: '100%', height: 0, paddingBottom: '56.250%' }}>
                            <iframe 
                              src="https://www.youtube.com/embed/4rUAH_l79Hs?si=xPKzqEOWSU6YrjEN" 
                              title="YouTube video player" 
                              frameBorder="0" 
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                              referrerPolicy="strict-origin-when-cross-origin" 
